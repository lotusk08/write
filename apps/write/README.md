...
The page itself stays chrome-free: one icon in the top-right opens a menu that
holds everything — drafts, front matter, settings, export and publish — and the
formatting toolbar is docked along the bottom.
...
- Front matter, drafts and settings share one drawer rather than a sidebar, a
  top bar and two dialogs; only the publish confirmation is still a modal.
